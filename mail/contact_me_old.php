...
$to = 'paul.willot.2@gmail.com'; // Add your email address inbetween the '' replacing yourname@yourdomain.com - This is where the form will send a message to.
...
$mail = new SimpleMail();
$mail->setTo('kiwi.pwillot@gmail.com', 'Your Email')
     ->setSubject('subject')
     ->setFrom('paul.willot.2@gmail.com', 'gmail.com')
     ->addMailHeader('Reply-To', 'paul.willot.2@gmail.com', 'paul.willot.2@gmail.com')
